...
def resize_and_rotate_images_in_folder(folder_path, output_folder, new_width=None, new_height=None):
    ...
    for filename in os.listdir(folder_path):
        ...
        if filename.endswith(('.jpg', '.jpeg', '.png', '.bmp')):
            ...
            # Flip vertical de l'image
            flipped_image = flip_image_vertically(resized_image)
            ...
            # Enregistrer l'image redimensionnée, rotée et flipée dans le dossier de sortie
...
# Redimensionner, faire une rotation de 180 degrés et un flip vertical sur toutes les images dans le dossier spécifié
